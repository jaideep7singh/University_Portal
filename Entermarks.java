...
public class Entermarks extends JFrame implements ActionListener {
    ...
    Entermarks() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Assets/image.png"));
        ...
        lblrollnuber.setBounds(50, 70, 150, 35);
        add(lblrollnuber);

        // Dropdown to hold roll numbers
        crollno = new Choice();
        crollno.setBounds(200, 75, 150, 20);
        add(crollno);
        ...
        JLabel blsemester = new JLabel("Select Semester");
        blsemester.setBounds(50, 110, 150, 35);
        add(blsemester);
        ...
        cbsemester.setBounds(200, 115, 150, 20);
        ...
        lblentermarks.setBounds(320, 148, 200, 40);
        add(lblentermarks);
