...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String rollno) {
        ...
        JLabel heading = new JLabel("SRMIST Delhi NCR Campus");
        ...
        JLabel lblsemsster = new JLabel();
        lblsemsster.setBounds(60, 130, 500, 20);
        lblsemsster.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(lblsemsster);
        ...
        try {
            ...
            while (rs2.next()) {
                ...
                lblsemsster.setText("Semester" + rs2.getString("semester"));
