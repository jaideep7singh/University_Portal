...
public class UpdateTeacher extends JFrame implements ActionListener {
    // Globally declared
    JTextField tfqualificaion, tfaddress, tfemail, tfphone, tfdepartment;
    JLabel labelempid;
    ...
    UpdateTeacher() {
        ...
        JLabel lblrollnuber = new JLabel("Select Employee ID");
        ...
        cempid = new Choice();
        cempid.setBounds(250, 110, 200, 20);
        add(cempid);
        ...
        labelempid.setFont(new Font("Tohama", Font.PLAIN, 20));
        add(labelempid);
        ...
        labelaadhar.setFont(new Font("Tahama", Font.PLAIN, 18));
        add(labelaadhar);

        JLabel lblqualification = new JLabel("Qualificaion");
        lblqualification.setBounds(50, 400, 200, 30);
        lblqualification.setFont(new Font("Serif", Font.BOLD, 20));
        add(lblqualification);

        tfqualificaion = new JTextField();
        tfqualificaion.setBounds(200, 400, 150, 30);
        tfqualificaion.setBackground(Color.WHITE);
        add(tfqualificaion);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tfqualificaion.setText(rs.getString("qualificaion"));
            ...
            public void itemStateChanged(ItemEvent ie) {
                try {
                    ...
                    while (rs.next()) {
                        ...
                        labelaadhar.setText(rs.getString("aadhar"));
                        labelempid.setText(rs.getString("empid"));
                        tfqualificaion.setText(rs.getString("qualification"));
                        tfdepartment.setText(rs.getString("department"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String qualification = tfqualificaion.getText();
            String department = tfdepartment.getText();

            try {
                String query = "update teacher set address =  '" + address + "'  , phone = '" + phone + "', email = '"
                        + email + "', qualification = '" + qualification + "', department =  '" + department
                        + "' where empid = '" + empid + "'";
